#!/bin/bash
# Build script for CoopGameFleep project
...
echo -e "${GREEN}Building CoopGameFleep project...${NC}"
...
"$BUILD_SCRIPT" CoopGameFleepEditor Linux Development -Project="$PROJECT_FILE"
